...
import CalculadoraDesgaste from "./pages/CalculadoraDesgaste";
...
import Zequinha from "./pages/Zequinha";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/ferramentas/zequinha" element={<Zequinha />} />
          <Route path="/ferramentas/calculadora-desgaste" element={<CalculadoraDesgaste />} />
